...
$$.WorldMap = {"": "Object;skyBitmap,skyBitmap2,cloudMovingSpeed,duration>,terrainHeights,tileDirts,tileOceans,terrain@,bricks<,ends<,x,y,width,height,speedX,speedY,direction,buttonMode,useHandCursor,hitArea,_graphics,_dropTarget,_children,_mouseChildren,_tabChildren,doubleClickEnabled,mouseEnabled,tabEnabled,tabIndex,_liblib3$_id,_x,_y,_pivotX,_pivotY,_scaleX,_scaleY,_skewX,_skewY,_rotation,_alpha,_visible,_off,_mask,_cache,_name,_parent,_tmpMatrix,_transformationMatrixPrivate,_transformationMatrixRefresh,_eventStreams",
  ...
  addBird$2: function(i, j) {
    ...
    try {
      ...
      $.unwrapException(exception);
      $.Primitives_printString("Error in create robot");
    }
...
$$.BitmapData = {"": "Object0;_width,_height,_transparent,_renderMode,_destinationWidth,_destinationHeight,_destinationX,_destinationY,_sourceX,_sourceY,_sourceWidth,_sourceHeight,_liblib3$_source,_context",
  get$width: function(_) {
    return this._width;
  },
  get$height: function(_) {
  ...
  render$1: function(renderState) {
    ...
    switch (this._renderMode) {
      case 0:
        $.drawImage$3$x(renderStateContext, this._liblib3$_source, this._destinationX, this._destinationY);
        break;
      case 1:
        $.drawImageScaledFromSource$9$x(renderStateContext, this._liblib3$_source, this._sourceX, this._sourceY, this._sourceWidth, this._sourceHeight, this._destinationX, this._destinationY, this._destinationWidth, this._destinationHeight);
        break;
      case 2:
        ...
        t4.drawImageScaledFromSource$9(renderStateContext, this._liblib3$_source, this._sourceX, this._sourceY, this._sourceHeight, this._sourceWidth, 0, 0, this._destinationHeight, this._destinationWidth);
        break;
    }
  },
    ...
    switch (this._renderMode) {
      ...
      case 1:
        ...
        if (iWidth > 0 && iHeight > 0)
          $.drawImageScaledFromSource$9$x(renderStateContext, this._liblib3$_source, iLeft, iTop, iWidth, iHeight, this._destinationX - fLeft + iLeft, this._destinationY - fTop + iTop, iWidth, iHeight);
        break;
      case 2:
        fLeft = this._sourceX;
        fTop = this._sourceY;
        ...
        if (typeof t2 !== "number")
          throw $.iae(t2);
        cTop = t4 - t3 + t2;
        t2 = $.JSNull_methods.get$height(clipRectangle);
        if (typeof t2 !== "number")
          throw $.iae(t2);
        cRight = cLeft + t2;
        t2 = $.JSNull_methods.get$width(clipRectangle);
        if (typeof t2 !== "number")
          throw $.iae(t2);
        cBottom = cTop + t2;
        iLeft = fLeft > cLeft ? fLeft : cLeft;
        ...
        if (iWidth > 0 && iHeight > 0) {
          ...
          t1.transform$6(renderStateContext, 0, -1, 1, 0, this._destinationX - fTop + iTop, this._destinationY + fRight - iRight + iHeight);
          t1.drawImageScaledFromSource$9(renderStateContext, this._liblib3$_source, iLeft, iTop, iHeight, iWidth, 0, 0, iHeight, iWidth);
        }
        break;
    }
  },
...
$$.Stage = {"": "DisplayObjectContainer;_canvas,_context,_defaultWidth,_defaultHeight,_canvasWidth,_canvasHeight,_clientWidth,_clientHeight,_clientTransformation,_stageTransformation,_renderLoop?,_juggler,_focus,_renderState,_stageRenderMode,_stageScaleMode,_stageAlign,_mouseCursor,_mousePosition<,_mouseTarget,_mouseButtons,_touches,_mouseEvent,_keyboardEvent,_touchEvent,_touchEventSubscriptions,_children,_mouseChildren,_tabChildren,doubleClickEnabled,mouseEnabled,tabEnabled,tabIndex,_liblib3$_id,_x,_y,_pivotX,_pivotY,_scaleX,_scaleY,_skewX,_skewY,_rotation,_alpha,_visible,_off,_mask,_cache,_name,_parent,_tmpMatrix,_transformationMatrixPrivate,_transformationMatrixRefresh,_eventStreams",
  ...
  _updateCanvasSize$0: function() {
    ...
    client = $.getBoundingClientRect$0$x(this._canvas);
  ...
  _onTouchEvent$1: function($event) {
    ...
    for (t2 = $.get$iterator$ax(t1.get$changedTouches($event)); t2.moveNext$0();) {
      ...
      t4 = this._touches;
      touch = t3 ? t4.$index(t4, identifier) : $._Touch$(target, t4.get$length(t4) === 0);
...
$$._FontStyleMetrics = {"": "Object0;fontStyle,ascent<,descent<,height*",
  _FontStyleMetrics$1: function(fontStyle) {
    ...
    $.append$1$x(div, text);
    $.append$1$x($.get$body$x($.document()), div);
    try {
...
$.main = function() {
  $.stage = $.Stage$("oneStage", $.query$1$x(document, "#oneStage"));
